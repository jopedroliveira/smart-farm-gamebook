...
- `src/routes/api/sage/+server.js` -- Claude integration with tool use (9 tools + web search: notas, rotacoes, canteiros, historico, tarefas, especies, pesquisa de especies com web search) and SSE streaming
